...
//         related to R&D activities. The idea is that reducing the social security
//         contributions for these employees lowers the overall cost of conducting
//         R&D, thus incentivizing innovation.
//       </div>
//     ),
//   },
//   {
//     question:
//       'What was the purpose of increasing the ceiling amount per month per group and not per project?',
//     options: [
//       {
//         key: 1,
//         option: 'To reduce the total funding available to companies',
//       },
//       {
//         key: 2,
//         option:
//           'To prevent companies from exploiting the system by creating multiple entities to bypass the cap.',
//       },
//       {
//         key: 3,
//         option: 'Because the budget would not suffice without a cap.',
//       },
//       {
//         key: 4,
//         option:
//           'This is an arbitrary rule set by Skatteverket without explaining its reason.',
//       },
//     ],
//     answer: 1,
//     explanation: (
...
//           More Info:
//         </Title>
//         In July 2023, Sweden set the ceiling to SEK 3 million per month per
//         group to prevent companies from exploiting the system by creating
//         multiple entities. Each entity within a group can still receive up to
//         SEK 3 million, but the cap applies at the group level, ensuring fairness
...
const suffledQuestions = shuffleArray(quizElements);

const RDTheoryQuiz = () => {
  const [animation, setAnimation] = useState('animation-class');
  const carouselRef = useRef<any>(null); // Create a reference to the Carousel
